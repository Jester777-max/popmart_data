...
OVERSEAS_CITY = {
    ...
    # 国家/地区名（首都/代表城市坐标）——用于只给到国家、未给城市的线索
    "泰国": ("Thailand", 13.7563, 100.5018), "越南": ("Vietnam", 21.0278, 105.8342),
    "印度尼西亚": ("Indonesia", -6.2088, 106.8456), "印尼": ("Indonesia", -6.2088, 106.8456),
    "马来西亚": ("Malaysia", 3.139, 101.6869), "菲律宾": ("Philippines", 14.5995, 120.9842),
    "日本": ("Japan", 35.6762, 139.6503), "韩国": ("South Korea", 37.5665, 126.978),
    "英国": ("United Kingdom", 51.5074, -0.1278), "法国": ("France", 48.8566, 2.3522),
    "意大利": ("Italy", 41.9028, 12.4964), "荷兰": ("Netherlands", 52.3676, 4.9041),
    "西班牙": ("Spain", 40.4168, -3.7038), "德国": ("Germany", 52.52, 13.405),
    "丹麦": ("Denmark", 55.6761, 12.5683), "澳大利亚": ("Australia", -33.8688, 151.2093),
    "澳洲": ("Australia", -33.8688, 151.2093), "新西兰": ("New Zealand", -36.8485, 174.7633),
    "加拿大": ("Canada", 43.6532, -79.3832), "阿联酋": ("United Arab Emirates", 25.2048, 55.2708),
    "墨西哥": ("Mexico", 19.4326, -99.1332), "巴西": ("Brazil", -23.5505, -46.6333),
}
